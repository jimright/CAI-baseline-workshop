...
def main():
    ...
    st.title("📊 Drift Detection Report")
    ...
    with st.sidebar:
        ...
        **Data Sources:**
        ...
        st.header("🔄 How to Generate Report")
        st.markdown("""
    ...
    with st.expander("🔧 Debug Information"):
        ...
        st.write(f"📄 Drift Report exists: {report_exists}")
        st.write(f"📄 Drift Status exists: {status_exists}")
